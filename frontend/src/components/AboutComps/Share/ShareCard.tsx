  ...
  return (
    <div>
      ...
      <IonList>
          ...
          <IonItem lines="none">
            <IonAvatar slot="start">
              <img alt='' src="https://lh3.googleusercontent.com/bYtqbOcTYOlgc6gqZ2rwb8lptHuwlNE75zYJu6Bn076-hTmvd96HH-6v7S0YUAAJXoJN" />
            </IonAvatar>
          ...
          <IonItem lines="none">
            <IonAvatar slot="start">
              <img alt='' src="https://pbs.twimg.com/profile_images/1242271512381571072/AYXTj2vl_400x400.png" />
            </IonAvatar>
